...
//            VendorAdminDTO vendorAdminDTO = VendorAdminAdapter.toDTO(vendorAdmin.get());
//            vendorAdminDTO.getAccount().setPassword("********");
...
//
//    @Override
//    public VendorAdminDTO addVendorAdmin(VendorAdminDTO vendorAdminDTO, Long vendorId){
//
//        Optional<VendorAdmin> vendorAdminOptional = vendorAdminRepository.findById(vendorId);
